...
//// Update methods are checked. Time step size calculations are tested against static case.
//// - The tests are good so far. Runge-Kutta is exploding after a significant amount of time, whereas Trapezoid seems fairly stable for greater time periods.
//*******************************************************************/
...
//  //sheet2 = new FlexibleSheet(L, M, N, stiff, damp, offsetX-100, offsetY, alignX);
//  //sheet2.prtcl[0].makeFixed();
  
//  //sheet2.Calculate_Stretched_Positions(gravity);
